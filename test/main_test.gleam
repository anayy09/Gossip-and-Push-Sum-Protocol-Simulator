...
import main.{get_command_line_args, parse_algorithm, parse_topology}
import topology
import utils
...
pub fn get_command_line_args_valid_test() {
  ...
  |> should.equal(Ok(#(100, topology.Full, main.Gossip, 0.1)))
}
